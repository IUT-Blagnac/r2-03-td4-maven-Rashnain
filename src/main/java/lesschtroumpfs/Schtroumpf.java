...
public class Schtroumpf {
	...
	**/
	...
	/** Fait tourner la Terre très rapidement mais pour un seul Schtroumpf
	...
	**/
	 ...
	 * Le rend mécontent car il doit se prostituer et il n'aime pas trop ça
	**/
	public void allerTravailler() {
		this.content = false;
	}
	
	/** Renvoit le village du Schtroumpf
